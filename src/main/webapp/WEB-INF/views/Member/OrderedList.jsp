...
<%@ include  file="../includes/header.jsp"%>
		...
		<div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header text-center text-white">주문 목록</h1>
                    </div>
                </div>
                 <br>
                 <br>
        		...
        		<ol class = "orderedList">
        			<c:forEach items="${orderedList}" var = "orderedList">
        				<li style='border:5px solid #eee; padding:10px 20px; margin-bottom:20px;'>
        					<p><span style ='font-size:20px; font-weight:bold; display:inline-block; width:90px; margin-right:10px;'>주문 번호</span><a href = "/Member/OrderedView?orderId=${orderedList.orderId}">${orderedList.orderId}</a></p>
